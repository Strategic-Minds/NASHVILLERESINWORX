...
const beautyCoatImage = "https://cdn.shopify.com/s/files/1/0754/8905/0678/files/nashville-resin-worx-beauty-coat-wet-on-wet-large-waves.png?v=1780974666";
...
export function EstimateFormEnhancer() {
  useEffect(() => {
    ...
    installProcessStepImage("Beauty Coat", beautyCoatImage, "Nashville Resin Worx beauty coat wet on wet metallic epoxy with large diagonal waves");
