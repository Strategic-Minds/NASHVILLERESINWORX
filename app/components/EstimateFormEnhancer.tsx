...
const baseCoatImage = "https://cdn.shopify.com/s/files/1/0754/8905/0678/files/nashville-resin-worx-basecoat-jeremy-eden-garage.png?v=1780971229";
...
export function EstimateFormEnhancer() {
  useEffect(() => {
    ...
    installProcessStepImage("Base Coat", baseCoatImage, "Nashville Resin Worx base coat Jeremy pouring epoxy and Eden back rolling");
