...
const topcoatImage = "https://cdn.shopify.com/s/files/1/0754/8905/0678/files/nashville-resin-worx-topcoat-eden-new-position-direction.jpg?v=1780983150";
...
export function EstimateFormEnhancer() {
  useEffect(() => {
    ...
    installProcessStepImage("Topcoat Finish", topcoatImage, "Nashville Resin Worx topcoat finish Eden rolling from a new position and direction");
